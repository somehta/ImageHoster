...
public class UserController {
    ...
    //Password given by user must contain atleast 1 alphabet, 1 number & 1 special character
    //This method validates password and calls the business logic and after the user record is persisted in the database, directs to login page
